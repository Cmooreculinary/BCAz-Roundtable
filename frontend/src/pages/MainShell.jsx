      ...
      <div className="app-body">
        ...
        <main className="main-content" data-testid="main-content">
          <Routes>
            ...
            <Route path="/micro" element={<Portal tables={tables} notifications={notifications} loadTables={loadTables} loadNotifications={loadNotifications} onOpenInvite={() => openModal("invite", { tables })} onOpenShare={() => openModal("shareItem", { tables })} onCreateTable={() => openModal("createTable")} onNewEvent={() => openModal("newEvent", { tables })} onGoto={nav} />} />
            <Route path="/MICRO" element={<Portal tables={tables} notifications={notifications} loadTables={loadTables} loadNotifications={loadNotifications} onOpenInvite={() => openModal("invite", { tables })} onOpenShare={() => openModal("shareItem", { tables })} onCreateTable={() => openModal("createTable")} onNewEvent={() => openModal("newEvent", { tables })} onGoto={nav} />} />
